                      ...
                      <div className="w-full md:w-1/4">
                        <div className="flex flex-col gap-3">
                          {property?.propertyImage?.[1] && (
                            <img
                              src={property.propertyImage[1]}
                              alt="Main Property"
                              className="w-full h-auto max-h-[380px] object-cover rounded-xl"
                            />
                          )}
                          {property?.propertyImage?.[2] && (
                            <img
                              src={property.propertyImage[2]}
                              alt="Main Property"
                              className="w-full h-auto max-h-[380px] object-cover rounded-xl"
                            />
                          )}
                          {property?.propertyImage?.[3] && (
                            <img
                              src={property.propertyImage[3]}
                              alt="Main Property"
                              className="w-full h-auto max-h-[380px] object-cover rounded-xl"
                            />
                          )}
                    ...
                    >
                      <div className="flex flex-wrap items-center justify-between gap-x-4">
                        ...
                        <p className="text-xs text-gray-400">
                          ...
                          <span className="text-gray-600">
                            {new Date(
                              property.createdAt
                            ).toLocaleDateString() ?? "Jan 12, 2025"}
                          </span>
                        </p>
                      </div>
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-x-4 mt-3">
                        ...
                        <p className="text-sm text-gray-600">
                          <span className="text-gray-300 mr-1">📞</span> +234
                          703 888 9412
                        </p>
                      </div>
