  ...
  return (
    <div className="min-h-screen bg-white text-[rgb(26, 24, 24)] font-serif flex flex-col justify-between">
      ...
      <section className="min-h-screen flex items-center justify-center md:mt-10 px-4 sm:px-8 lg:px-40">
        ...
        List, Discover, & Acquire The Right  {" "} <span className="inline italic text-[#00E5FF] font-bold font-playfair text-[28px] md:text-6xl md:">
         Space
       </span> {" "}
        for Your Business.
       </h1>
       <div className="flex justify-center">
         <p className="text-xs md:text-xl text-[#1D3F3FDE] mt-8 font-aeonik font-normal text-center max-w-[307px] md:max-w-[847px] min-h-[56px]">
    Looking for warehouses, industrial spaces that meet your needs? Do you want to
    <span className="italic text-[#00E5FF] text-xs md:text-xl"> lease</span> a
    <span className="md:inline"> property,</span>
    <span className="italic text-[#00E5FF] text-xs md:text-xl"> Share</span> a space with others,
    <span className="italic text-[#00E5FF] text-xs md:text-xl"> list</span> your industrial properties work for you,
    <span className="italic text-[#00E5FF] text-xs md:text-xl"> but</span> or
    <span className="italic text-[#00E5FF] text-xs md:text-xl"> Sell</span> them?
  </p>
</div>

    {/* Cards with Radio Buttons */}
        <div className="flex flex-col sm:flex-row gap-6 items-center justify-center mt-7">
...
<section className="py-20 px-4 sm:px-4 lg:px-8 bg-[#FFFFFF] border-b border-gray-300">
  <div className="w-full max-w-full mx-auto">
    ...
    <div className="flex flex-col md:flex-row items-center gap-12">
     ...
     <h3 className="text-start text-xl md:text-2xl font-bold mb-4 font-aeonik text-[#1D3F3F]">What We Do</h3>
       ...
       <span className="hidden md:block">warehouses and industrial spaces that meet their</span>
       <span className="hidden md:block">exact needs either for the long-term or short-term.</span>
       <span className="block md:hidden">warehouses and industrial spaces that meet their exact needs either for the long-term or short-term.</span>
       </p>
      <button className="bg-[#1C1C1C] text-[#FFF7F2] items-center px-6 py-3 rounded-[50px] font-bold hover:bg-[#1C1C1C]"
        onClick={handleClick}
      >
         Learn More
       </button>
      ...
      {[
        {
          ...
          descriptions: [
            ...
            <>
              ...
              and fill the enquiry form to inquire about those that interest you.
            </>,
          ],
        },
        {
        ...
        },
        {
          ...
          descriptions: [
            <>
              We arrange joint inspections of the properties with you so you can <br /> assess them in person before making a decision.
            </>,
          ],
        },
        {
          ...
          descriptions: [
            <>
              We provide you with offers for your choice property and <br /> negotiate favorable terms to ensure the best deal for you.
            </>,
          ],
        },
        {
...
<div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border border-gray-200 
  ...
  <div className="flex-1 flex flex-col bg-[#FFFFFF] shadow-md rounded-r-md 
    ...
    <h3 className="text-xl md:text-3xl font-medium font-yeseva text-[#1D3F3F]">
      The Ultimate Guide to Renting a<br className="hidden sm:inline" /> Warehouse Space
    </h3>

    {/* Description */}
    <p className="text-[#627777] text-sm md:text-base font-normal font-aeonik leading-relaxed">
      Finding the right warehouse can be overwhelming.<br className="hidden sm:inline" />
      This guide walks you through key factors like location, size,<br className="hidden sm:inline" />
    ...
    <div className="flex flex-wrap items-center justify-between gap-4 sm:gap-6">
      {/* Read More Button */}
      <button className="px-9 py-3 bg-[#1C1C1C] text-white rounded-full text-sm font-semibold hover:bg-[#1D3F3F75] transition"
      ...
      <Link to="/blog" className="text-[#00E5FF] text-lg font-normal font-aeonik hover:underline">
        View More Insight →
      </Link>
    </div>
  </div>
...
<div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6">
  ...
  {/* Date */}
  <p className="text-[10px] md:text-base text-[#1D3F3F75] md:mt-3">February 25, 2024</p>
  ...
  {/* Title */}
  <p className="font-medium font-yeseva text-[8px] md:text-lg text-[#1D3F3FDE] mt-2">
  Shared Warehousing: A Cost-Effective Solution for Small Businesses
  </p>
