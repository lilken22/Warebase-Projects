  ...
  return (
    <div className="min-h-screen bg-white font-serif flex flex-col">
      ...
      <section className="py-16 px-6 sm:px-12 lg:px-36 text-center mt-16">
        <h2 className="text-base md:text-[57px] font-normal font-yeseva text-[#1D3F3F]">
          About Us
        </h2>
        <p className="text-sm md:text-lg text-[#1D3F3F] font-aeonik mt-8 max-w-2xl mx-auto">
          We make it easy for organisations to find warehouses and industrial
          spaces that meet their exact needs either for the long-term or
          short-term.
        </p>
        ...
        <div className="mt-12 flex flex-col gap-12 lg:gap-20 items-center">
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-6 md:text-left mt-8">
            <div className="max-w-xl order-2 md:order-1">
              <h3 className="text-3xl font-bold font-aeonik text-left text-[#1D3F3F]">
                Our Mission
              </h3>
              <p className="text-[#1D3F3F] mt-2 md:text-base max-w-xl font-aeonik text-left">
                At Warebase, our mission is to connect businesses with the
                perfect warehouse spaces by providing a seamless, efficient, and
                data-driven property listing platform. We strive to simplify
                warehouse leasing and sales by offering a user-friendly
                experience, comprehensive listings, and valuable insights that
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 md:text-left mt-8">
            <div className="max-w-xl order-2 md:order-1">
              ...
              <p className="text-[#1D3F3F] mt-2 md:text-base max-w-xl font-aeonik text-left">
                Warebase envisions becoming the leading platform for warehouse
                property listings, revolutionizing the way businesses discover,
                lease, and manage industrial spaces. We aim to create a seamless
                marketplace where efficiency, transparency, and innovation drive
                smarter real estate decisions for businesses worldwide.
              </p>
            </div>
            <img
              src="/vision.png"
  ...
  h-[210px] w-[290px] flex flex-col justify-between mx-auto md:mx-5"
          >
            ...
            <p className="text-xs md:text-base text-[#627777] text-start leading-tight">
              Finding a warehouse space that met our storage needs used to be a
              challenge, but this platform made it seamless. The process was
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border border-gray-200 lg:h-[334px] lg:w-[320px] h-[210px] w-[290px] flex flex-col justify-between mx-auto md:mx-5">
            ...
            <p className="text-xs md:text-base text-[#627777] text-start leading-tight">
              ...
              connected us with the perfect space. The transparency and ease of
              use exceeded our expectations!
            </p>
            <div className="flex items-center mt-4 md:mt-6 gap-2 md:gap-5">
              <img
                src="/Gbenga.jpeg"
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md border border-gray-200 lg:h-[334px] lg:w-[320px] h-[210px] w-[290px] flex flex-col justify-between mx-auto md:mx-5">
            ...
            <p className="text-xs md:text-base text-[#627777] text-start leading-tight">
              This service has been a game-changer for our leasing business. The
              platform attracts serious clients, and the user experience is
              top-notch!
            </p>
            <div className="flex items-center mt-4 md:mt-6 gap-2 md:gap-5">
              <img
      ...
      <section className="py-20 px-4 sm:px-12 lg:px-36">
        {/* Section Title */}
        <h2 className="text-base md:text-[57px] font-normal font-yeseva text-[#1D3F3F] text-center mb-2">
          Our People
        </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-8">
          ...
          <div className="flex flex-col items-center bg-white shadow-md rounded-[4px]   overflow-hidden">
            <img
              src="/image doe.png"
              alt="Chidi Okafor"
              className="w-full md:h-[208px] object-fill"
            />
            <div className="p-3 text-start">
              <h3 className="md:text-xl font-normal font-yeseva text-[#1D3F3FDE]">
                John Doe
              </h3>
              <p className="text-base font-normal font-aeonik text-[#1D3F3F75]">
                Executive Role
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col shadow-md rounded-lg bg-white overflow-hidden text-center">
            ...
            <div className="p-4 text-start">
              <h2 className="md:text-xl font-normal font-yeseva text-[#1D3F3FDE]">
                John Doe
              </h2>
              <p className="text-base font-normal font-aeonik text-[#1D3F3F75]">
                Executive Role
      ...
      <section className="flex flex-col items-center w-full max-w-screen-lg mx-auto mt-14">
        ...
        <p className="text-center text-[#1D3F3F] max-w-xs md:max-w-md font-aeonik font-normal text-lg mb-6">
          Browse through our services gallery and choose one or more that align
          with your needs.
        </p>
